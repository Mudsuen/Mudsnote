...
- Regression coverage must prove the concise menu titles, Insert submenu, trailing-whitespace selection preservation, selection-format menu structure, formatting undo/redo, source/render switching, and `<mark>` rich-text round trip.
