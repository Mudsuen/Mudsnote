...
- Titlebar, list headers, default window proportion, and shared layout metrics are closer to Notes, with a larger first-launch desktop window, screen-clamped presentation, and stronger toolbar/editor spacing metrics.
