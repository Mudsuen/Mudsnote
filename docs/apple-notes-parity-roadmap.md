...
- Toolbar has editing tools, Markdown export/share affordances for copying content and exporting files, a more-actions menu, a wider Notes-like search field, stateful source-list toggling, and context-aware disabled states, but still needs richer system share destinations.
