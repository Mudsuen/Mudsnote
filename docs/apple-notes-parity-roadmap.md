...
- Search is in the top toolbar and supports current/all scoping with visible row highlights, no-result feedback, and keyboard transitions from search to result list/editor, but still lacks indexing and full result navigation polish.
