...
- Note-list rows show bounded body previews, a darker Notes-like column, and a compact attachment paperclip indicator, but still need exact row spacing, thumbnail previews, and keyboard navigation polish.
