...
- Editor now uses a centered date-only header for loaded notes, debounced autosave for editable library notes, and lighter save-progress copy, but still needs exact title/body vertical spacing and side-by-side visual tuning.
