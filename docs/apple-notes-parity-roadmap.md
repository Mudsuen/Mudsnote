...
- Packaged app smoke now covers direct launch, create/edit/save, search, delete to Recently Deleted, restore, and folder move through `scripts/library_smoke.sh`; attachment rendering still needs installed-app smoke coverage.
