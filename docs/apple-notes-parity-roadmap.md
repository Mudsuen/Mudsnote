...
- Editor now uses a centered date-only header for loaded notes, explicit left-aligned note titles, debounced autosave, lighter save-progress copy, compact Notes-like title/body typography, wider body line rhythm, and tighter date/title/body spacing, but still needs side-by-side visual tuning.
