...
- Visual QA has a repeatable active-window side-by-side harness against the supplied Apple Notes screenshot, but still needs per-iteration delta notes and closer visual tuning.
