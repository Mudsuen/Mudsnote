...
- Source list has compact group labels, counts, lightweight nested folder rows, and session-local disclosure controls, but still defers tag rows from the launch path and needs more exact Apple Notes spacing polish.
