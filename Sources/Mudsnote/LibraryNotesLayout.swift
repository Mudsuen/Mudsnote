...
enum LibraryNotesLayout {
    ...
    static let noteColumnMinimumWidth: CGFloat = 250
    static let noteColumnMaximumWidth: CGFloat = 380
    ...
    static let noteGroupRowHeight: CGFloat = 26
    ...
    static let noteListLeadingInset: CGFloat = 6
    static let noteListTrailingInset: CGFloat = 6
    static let noteListTopInset: CGFloat = 0
    static let noteListStackTopOffset: CGFloat = 0
    static let noteListBottomInset: CGFloat = 4
    ...
    static let editorBottomInset: CGFloat = 4
