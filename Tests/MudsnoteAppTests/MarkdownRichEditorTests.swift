...
struct MarkdownRichEditorTests {
    ...
    func libraryWindowUsesNotesLikeSplitAndLoadsFirstNote() throws {
        ...
        #expect(LibraryNotesLayout.sourceRowWidth == 272)
        ...
        #expect(LibraryNoteRowView.selectionHorizontalInset == 10)
        #expect(LibraryNoteRowView.selectionVerticalInset == 6)
        #expect(LibraryNoteRowView.selectionCornerRadius == 7)
        ...
        #expect(LibraryNoteCellView.contentLeadingInset == 28)
        #expect(LibraryNoteCellView.contentBottomInset == 10)
        #expect(LibraryNoteCellView.contentTrailingInset == 12)
