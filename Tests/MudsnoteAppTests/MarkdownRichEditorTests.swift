...
struct MarkdownRichEditorTests {
    ...
    func libraryWindowUsesNotesLikeSplitAndLoadsFirstNote() throws {
        ...
        #expect(LibraryNotesLayout.storedLayoutScaleVersion == 6)
        ...
        #expect(LibraryNotesLayout.sourceColumnWidth == 212)
        ...
        #expect(LibraryNotesLayout.sourceRowWidth == 184)
        ...
        #expect(LibraryNotesLayout.sourceColumnMinimumWidth == 212)
        ...
        #expect(LibraryNotesLayout.sourceColumnWidth - LibraryNotesLayout.noteColumnWidth == 12)
