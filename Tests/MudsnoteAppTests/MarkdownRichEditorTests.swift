...
struct MarkdownRichEditorTests {
    ...
    func libraryWindowUsesNotesLikeSplitAndLoadsFirstNote() throws {
        ...
        #expect(LibraryNotesLayout.initialWindowSize == NSSize(width: 1420, height: 820))
        #expect(LibraryNotesLayout.presentedWindowSize == NSSize(width: 1420, height: 860))
        #expect(LibraryNotesLayout.sourceColumnWidth == 320)
        #expect(LibraryNotesLayout.noteColumnWidth == 304)
        #expect(LibraryNotesLayout.sourceColumnWidth > LibraryNotesLayout.noteColumnWidth)
        #expect(LibraryNotesLayout.noteTableInitialWidth == 278)
        #expect(LibraryNotesLayout.noteTableMinimumWidth == 272)
        #expect(LibraryNotesLayout.sourceRowWidth == 292)
        ...
        #expect(LibraryNotesLayout.toolbarSearchWidth == 340)
        #expect(LibraryNotesLayout.toolbarSearchWrapperWidth == 360)
        ...
        let editorToolsView = try #require(editorToolsItem.view)
        ...
        #expect(LibraryNotesLayout.toolbarEditorToolsEnabledFillAlpha == 0.40)
        #expect(LibraryNotesLayout.toolbarEditorToolsDisabledFillAlpha == 0.22)
        ...
        #expect(LibraryNotesLayout.sourceRowHeight == 44)
        ...
        #expect(LibraryNotesLayout.sourceListTrailingInset == 14)
        #expect(LibraryNotesLayout.sourceSymbolPointSize == 19)
        #expect(LibraryNotesLayout.sourceDisclosureSymbolPointSize == 10)
        #expect(LibraryNotesLayout.sourceRowCornerRadius == 10)
        ...
        #expect(LibraryNotesLayout.sourceButtonFontSize == 18)
        ...
        #expect(LibraryNotesLayout.sourceCountFontSize == 16)
        ...
        #expect(LibraryGroupHeaderCellView.titleTrailingInset == 12)
        ...
        #expect(LibraryNoteRowView.selectionTrailingInset == 24)
        #expect(LibraryNoteRowView.selectionVerticalInset == 8)
        #expect(LibraryNoteRowView.selectionCornerRadius == 10)
        let selectionFill = try #require(LibraryNoteRowView.selectionFillColor.usingColorSpace(.genericRGB))
        #expect(abs(selectionFill.redComponent - 0.52) < 0.001)
        #expect(abs(selectionFill.greenComponent - 0.38) < 0.001)
        #expect(abs(selectionFill.blueComponent - 0.0) < 0.001)
        ...
        #expect(LibraryNoteRowView.separatorLeadingInset == LibraryNoteCellView.contentLeadingInset)
        ...
        #expect(LibraryNoteCellView.contentTopInset == 10)
        #expect(LibraryNoteCellView.contentLeadingInset == 46)
        #expect(LibraryNoteCellView.contentBottomInset == 10)
        #expect(LibraryNoteCellView.contentTrailingInset == 18)
        #expect(LibraryNoteCellView.textRowSpacing == 2)
        #expect(LibraryNotesLayout.noteGroupFontSize == 20)
        #expect(LibraryNotesLayout.noteGroupFontWeight == .bold)
        #expect(LibraryNotesLayout.noteTitleFontSize == 18)
        #expect(LibraryNotesLayout.noteTitleFontWeight == .bold)
        #expect(LibraryNotesLayout.noteSnippetFontSize == 15.5)
        #expect(LibraryNotesLayout.noteSnippetFontWeight == .medium)
        #expect(LibraryNotesLayout.noteMetaFontSize == 13)
        ...
        #expect(LibraryNotesLayout.editorBodyFontSize == 17)
        #expect(LibraryNotesLayout.editorCodeFontSize == 16)
    ...
    func libraryToolbarUsesNotesLikeDisabledStates() throws {
        ...
        func tintAlpha(_ button: NSButton) throws -> CGFloat {
            try #require(button.contentTintColor).alphaComponent
        }

        func editorToolTintAlphas(in controller: LibraryWindowController) throws -> [CGFloat] {
            try visibleEditorToolButtons(in: controller).map { try tintAlpha($0) }
        }
        ...
        func visibleEditorToolsFillAlpha(in controller: LibraryWindowController) throws -> CGFloat {
            try #require(visibleEditorToolsView(in: controller).layer?.backgroundColor?.alpha)
        }
        ...
        #expect(!emptyExportButton.isEnabled)
        #expect(!emptyMoreButton.isEnabled)
        #expect(emptyExportButton.alphaValue == 1)
        #expect(emptyMoreButton.alphaValue == 1)
        #expect(abs(try tintAlpha(emptyExportButton) - LibraryNotesLayout.toolbarIconDisabledAlpha) < 0.001)
        #expect(abs(try tintAlpha(emptyMoreButton) - LibraryNotesLayout.toolbarIconDisabledAlpha) < 0.001)
        ...
        #expect(abs(try visibleEditorToolsFillAlpha(in: emptyController) - LibraryNotesLayout.toolbarEditorToolsEnabledFillAlpha) < 0.001)
        #expect(try editorToolTintAlphas(in: emptyController).allSatisfy {
            abs($0 - LibraryNotesLayout.toolbarIconEnabledAlpha) < 0.001
        })
        #expect(abs(try tintAlpha(try visibleToolbarButton(in: emptyController, rawValue: "mudsnote.library.toolbar.more")) - LibraryNotesLayout.toolbarIconEnabledAlpha) < 0.001)
        ...
        #expect(abs(try visibleEditorToolsFillAlpha(in: selectedController) - LibraryNotesLayout.toolbarEditorToolsEnabledFillAlpha) < 0.001)
        #expect(try editorToolTintAlphas(in: selectedController).allSatisfy {
            abs($0 - LibraryNotesLayout.toolbarIconEnabledAlpha) < 0.001
        })
        #expect(abs(try tintAlpha(try visibleToolbarButton(in: selectedController, rawValue: "mudsnote.library.toolbar.export")) - LibraryNotesLayout.toolbarIconEnabledAlpha) < 0.001)
