...
struct MarkdownRichEditorTests {
    ...
    func libraryWindowUsesNotesLikeSplitAndLoadsFirstNote() throws {
        ...
        #expect(LibraryNotesLayout.sourceColumnWidth == 340)
        #expect(LibraryNotesLayout.noteColumnWidth == 340)
        #expect(LibraryNotesLayout.noteTableInitialWidth == 304)
        #expect(LibraryNotesLayout.sourceRowWidth == 300)
        ...
        #expect(LibraryNoteCellView.contentLeadingInset == 34)
