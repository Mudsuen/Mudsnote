...
struct MarkdownRichEditorTests {
    ...
    func libraryWindowUsesNotesLikeSplitAndLoadsFirstNote() throws {
        ...
        #expect(LibraryNotesLayout.sourceColumnWidth == 250)
        #expect(LibraryNotesLayout.noteColumnWidth == 250)
        #expect(LibraryNotesLayout.sourceColumnWidth == LibraryNotesLayout.noteColumnWidth)
        #expect(LibraryNotesLayout.noteTableInitialWidth == 224)
        #expect(LibraryNotesLayout.noteTableMinimumWidth == 194)
        #expect(LibraryNotesLayout.sourceRowWidth == 222)
        ...
        #expect(LibraryNotesLayout.toolbarSearchWidth == 210)
        ...
        let fileActionsGlass = try #require(fileActionsView as? NSGlassEffectView)
        #expect(fileActionsGlass.style == .regular)
        #expect(fileActionsGlass.cornerRadius == LibraryNotesLayout.toolbarFileActionsHeight / 2)
        ...
        let newNoteGlass = try #require(newNoteToolbarItem.view as? NSGlassEffectView)
        let newNoteToolbarButton = try #require(newNoteGlass.allSubviews.compactMap { $0 as? NSButton }.first)
        ...
        #expect(newNoteGlass.cornerRadius == LibraryNotesLayout.toolbarCircularButtonSize / 2)
        #expect(newNoteGlass.style == .regular)
        ...
        #expect(LibraryNotesLayout.sourceSymbolPointSize == 16)
        ...
        #expect(LibraryNotesLayout.sourceButtonFontSize == 15)
        ...
        #expect(LibraryGroupHeaderCellView.titleLeadingInset == 10)
        ...
        #expect(LibraryNoteCellView.contentLeadingInset == 36)
    ...
    func libraryToolbarUsesNotesLikeDisabledStates() throws {
        ...
        #expect(try visibleEditorToolsView(in: emptyController) is NSGlassEffectView)
